...
- `docs/03-delivery/`：任务交付资产（workshops/roadmap/specs/validation/backlog）。
...
6. `docs/03-delivery/workshops/README.md`（先走研讨流程）
7. `docs/03-delivery/roadmap/implementation-tasks-v0.3.md`
8. 对应任务文档：`docs/03-delivery/specs/<TASK>.md` + `docs/03-delivery/validation/<TASK>.md`
9. 协作与待办：`docs/05-agent/session-notes/session-notes.md` + `docs/03-delivery/backlog/`

## 规范说明
- 任务流程工具 `task_guard.py` 仅写入/校验：
  - `docs/03-delivery/specs`
  - `docs/03-delivery/validation`
- 研讨流程工具 `workshop_guard.py` 仅写入/校验：
  - `docs/03-delivery/workshops/items`
